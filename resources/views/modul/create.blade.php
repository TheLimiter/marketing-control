      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          <div class="col-md-3">
            ...
            <input class="form-control input-soft" name="kode" placeholder="mis. M-001">
          </div>
          <div class="col-md-5">
            <label class="form-label">Nama <span class="text-danger">*</span></label>
            <input class="form-control input-soft" name="nama" required placeholder="Nama modul">
          </div>
          <div class="col-md-2">
            <label class="form-label">Kategori</label>
            <input class="form-control input-soft" name="kategori" placeholder="Opsional">
          </div>
          <div class="col-md-2">
            <label class="form-label">Versi</label>
            <input class="form-control input-soft" name="versi" placeholder="v1.0">
          </div>
          ...
          <div class="col-12">
            ...
            <textarea class="form-control input-soft" name="deskripsi" id="deskripsi" rows="3" placeholder="Ringkas tujuan & cakupan modul"></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input class="form-control input-soft" name="harga_default" type="number" min="0" placeholder="0">
        </div>
...
<div class="position-sticky bottom-0 mt-3" style="z-index:10;">
  <div class="card p-3 d-flex flex-wrap gap-2 justify-content-between align-items-center">
    <div class="text-muted small">Pastikan nama & kode modul sudah benar.</div>
